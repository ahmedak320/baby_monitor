...
class MetadataGateService {
  ...
  static const _titleBlocklist = [
    'horror', 'scary', 'creepy', 'murder', 'kill', 'dead', 'death',
    'blood', 'gore', 'violence', 'violent', 'nsfw', 'adult', '18+',
    'explicit', 'drugs', 'drunk', 'sex', 'nude', 'naked', 'gun',
    'shooting', 'war', 'torture', 'disturbing', 'graphic', 'slaughter',
    'suicide', 'self-harm', 'abuse', 'assault', 'rape', 'molest',
    'hate', 'racist', 'terrorism', 'extremist', 'cult',
    'fnaf', 'five nights', 'siren head', 'huggy wuggy', 'poppy playtime',
    'squid game', 'elsagate', 'momo challenge',
  ];

  static const _descriptionBlocklist = [
    'not for children', 'viewer discretion', 'mature audiences',
    'age-restricted', 'parental advisory', '18+', 'nsfw',
    'graphic content', 'disturbing content',
  ];

  static const _kidsIndicators = [
    'kids', 'children', 'toddler', 'preschool', 'nursery',
    'baby', 'educational', 'learning', 'abc', 'sesame',
    'cartoon', 'animation', 'family friendly', 'for kids',
    'cocomelon', 'bluey', 'peppa', 'pinkfong',
  ];
}
