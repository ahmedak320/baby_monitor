-- Add playability metadata for safer kid-mode admission and cache repair.
...
ALTER TABLE yt_videos
    ...
    ADD COLUMN IF NOT EXISTS last_playability_check_at TIMESTAMPTZ;

CREATE INDEX IF NOT EXISTS idx_yt_videos_embeddable
    ON yt_videos(is_embeddable);

CREATE INDEX IF NOT EXISTS idx_yt_videos_made_for_kids
